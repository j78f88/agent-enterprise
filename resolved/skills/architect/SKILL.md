...
- `docs/architecture/DECISIONS.md` — canonical ADR log (append-only; ADRs are never deleted, only superseded)
- `docs/architecture/FUTURE_CONSIDERATIONS.md` — strategic notes that aren't decisions yet
- `docs/architecture/design-reviews//` — critique outputs for proposed approaches
...
2. Read `docs/architecture/DECISIONS.md` to know the existing ADRs.

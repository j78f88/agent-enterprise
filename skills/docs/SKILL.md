...
- **`{{paths.user_guide}}`** — Add/update sections for new features. Write for DIY enthusiasts, not developers. Step-by-step instructions, limitations, tips. Update the Table of Contents, "What's Coming Next", and "Last Updated" footer.

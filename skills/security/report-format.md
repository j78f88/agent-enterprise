...
- License denylist match on production dep AND `{{security.license_gate}}` is true

---

## Security Changelog Format

Append-only at `{{paths.security_changelog}}`. Entries are **never** modified or deleted.

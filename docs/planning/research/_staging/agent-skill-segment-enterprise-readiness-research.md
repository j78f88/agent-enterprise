...
**Prior local prototype snapshot (not included in this repository)** — README, package metadata, source tree, ADRs, and SOP docs reviewed as non-canonical background input.

...
- `docs/planning/ROADMAP.md` — living roadmap (phases + rationale)
- `docs/planning/validation/` — validation records
- `docs/planning/engagements/` — engagement assessments
- `docs/planning/FEATURE_MATRIX.md` — feature completion matrix

## Handoff

When a feature passes validation, write a handoff manifest to `docs/planning/_handoffs/` and direct the user to `@planner`.

For detailed workflow procedures, see `.github/agents/pm/SKILL.md`.
